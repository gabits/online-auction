    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(help_text='Auction owner.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='auctions', to='account.UserProfile')),
            ],
        ),
        migrations.CreateModel(
            name='Lot',
            fields=[
                ...
                ('auction', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='lot', to='auction.Auction')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(help_text='Bidding user.', on_delete=django.db.models.deletion.CASCADE, related_name='user', to='account.UserProfile')),
            ],
        ),
        migrations.AddIndex(
            model_name='bid',
            index=models.Index(fields=['auction', 'created_at'], name='auction_bid_auction_8ba5df_idx'),
        ),
        migrations.AddIndex(
            model_name='auction',
            index=models.Index(fields=['user', 'created_at'], name='auction_auc_user_id_d20252_idx'),
        ),
    ]
