    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='sale_record', to='auction.Lot')),
            ],
        ),
        migrations.AddField(
            model_name='bid',
        ...
        migrations.AddIndex(
            model_name='bid',
            index=models.Index(fields=['item', '-submitted_at'], name='auction_bid_item_id_c8a475_idx'),
        ),
    ]
